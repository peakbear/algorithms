...
public class KMeansIntegrationTest {
  ...
  public void cluster_singleCLuster() {
    ...
    List<Cluster> assignments = KMeans.cluster(TestPicks.singleCluster);
  ...
  public void cluster_testPick1() {
    ...
    int estimatedK = new BigDecimal(constraintSum).setScale(0, RoundingMode.CEILING).intValue();
    List<Cluster> assignments = KMeans.cluster(TestPicks.testPicks);
    assertEquals(estimatedK, assignments.size());
  }
  ...
  public void cluster_testPick2() {
    ...
    int estimatedK = new BigDecimal(constraintSum).setScale(0, RoundingMode.CEILING).intValue();
    List<Cluster> assignments = KMeans.cluster(TestPicks.testPicks2);
    assertEquals(estimatedK, assignments.size());
  }
  ...
  public void cluster_testPick3() {
    ...
    int estimatedK = new BigDecimal(constraintSum).setScale(0, RoundingMode.CEILING).intValue();
    List<Cluster> assignments = KMeans.cluster(TestPicks.testPicks3);
    assertEquals(estimatedK, assignments.size());
  }
}
